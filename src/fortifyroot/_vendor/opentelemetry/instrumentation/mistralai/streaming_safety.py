...
from fortifyroot._vendor.opentelemetry.instrumentation.mistralai.safety import PROVIDER
from fortifyroot._vendor.opentelemetry.semconv_ai import LLMRequestTypeValues


class MistralAIStreamingSafety:
    ...
    def process_chunk(self, item):
        chunk = get_object_value(item, "data") or item
