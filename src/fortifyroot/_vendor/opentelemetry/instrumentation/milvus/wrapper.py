import time
from fortifyroot._vendor.opentelemetry.instrumentation.milvus.utils import dont_throw
...
from fortifyroot._vendor.opentelemetry.semconv_ai import Events, EventAttributes
