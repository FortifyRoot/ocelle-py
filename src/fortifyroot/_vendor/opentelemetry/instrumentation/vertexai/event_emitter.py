...
from fortifyroot._vendor.opentelemetry.instrumentation.vertexai.event_models import (
    ChoiceEvent,
    MessageEvent,
)
from fortifyroot._vendor.opentelemetry.instrumentation.vertexai.utils import (
    dont_throw,
    should_emit_events,
    should_send_prompts,
)
