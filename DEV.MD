# FortifyRoot SDK – Developer Guide (DEV.md)
...
FortifyRoot SDK, and work effectively with Poetry and VS Code.
...
## 4. FortifyRoot SDK Setup

```bash
git clone https://github.com/FortifyRoot/fortifyroot-sdk-py
cd fortifyroot-sdk-py
deactivate || true
rm -rf .venv
