...
from fortifyroot._vendor.opentelemetry.instrumentation.llamaindex.event_emitter import (
...
from fortifyroot._vendor.opentelemetry.instrumentation.llamaindex.span_utils import (
    set_embedding,
...
from fortifyroot._vendor.opentelemetry.instrumentation.llamaindex.utils import (
    JSONEncoder,
    should_emit_events,
    should_send_prompts,
)
...
def instrument_with_dispatcher(tracer: Tracer):
    ...
    from fortifyroot._vendor.opentelemetry.instrumentation.llamaindex.retry_handler import (
...
class OpenLLMetrySpanHandler(BaseSpanHandler[SpanHolder]):
    ...
    def new_span(
        ...
        **kwargs: Any,
        ...
        from fortifyroot._vendor.opentelemetry.instrumentation.fortifyroot import emit_deferred_findings
