...
from fortifyroot._vendor.opentelemetry.instrumentation.ollama.event_models import (
    ChoiceEvent,
    MessageEvent,
    ToolCall,
)
from fortifyroot._vendor.opentelemetry.instrumentation.ollama.utils import (
    dont_throw,
    should_emit_events,
    should_send_prompts,
)
