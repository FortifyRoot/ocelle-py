...
async def aset_input_attributes(span, kwargs):
    from fortifyroot._vendor.opentelemetry.instrumentation.anthropic import set_span_attribute
...
async def _aset_span_completions(span, response):
    if not should_send_prompts():
        return
    from fortifyroot._vendor.opentelemetry.instrumentation.anthropic import set_span_attribute
    from fortifyroot._vendor.opentelemetry.instrumentation.anthropic.utils import _aextract_response_data
