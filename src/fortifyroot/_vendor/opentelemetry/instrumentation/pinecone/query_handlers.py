...
from fortifyroot._vendor.opentelemetry.semconv_ai import EventAttributes, Events, SpanAttributes
from fortifyroot._vendor.opentelemetry.instrumentation.pinecone.utils import dont_throw, set_span_attribute
