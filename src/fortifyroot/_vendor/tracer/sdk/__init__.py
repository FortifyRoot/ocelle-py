...
from fortifyroot._vendor.tracer.sdk.config import (
    is_content_tracing_enabled,
    is_tracing_enabled,
    is_metrics_enabled,
    is_logging_enabled,
)
from fortifyroot._vendor.tracer.sdk.fetcher import Fetcher
...
from fortifyroot._vendor.tracer.sdk.client.client import Client
from fortifyroot._vendor.tracer.sdk.associations.associations import AssociationProperty as AssociationProperty
...
class Traceloop:
    ...
    def get_default_span_processor(
        ...
        """
        from fortifyroot._vendor.tracer.sdk.tracing.tracing import get_default_span_processor
        if headers is None:
            if api_key is None:
