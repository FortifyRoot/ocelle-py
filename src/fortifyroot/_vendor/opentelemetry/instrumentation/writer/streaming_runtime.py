...
from fortifyroot._vendor.opentelemetry.instrumentation.writer.streaming_safety import (
...
def create_stream_processor_delegate(
    ...
    from fortifyroot._vendor.opentelemetry.instrumentation.writer import (
        _handle_response,
