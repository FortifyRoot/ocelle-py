...
from fortifyroot._vendor.opentelemetry.instrumentation.sagemaker.event_models import (
    ChoiceEvent,
    MessageEvent,
)
...
from fortifyroot._vendor.opentelemetry.instrumentation.sagemaker.utils import (
    should_emit_events,
    should_send_prompts,
)
