...
from fortifyroot._vendor.opentelemetry.instrumentation.openai.utils import is_openai_v1
...
class OpenAIInstrumentor(BaseInstrumentor):
    ...
    def _instrument(self, **kwargs):
        if is_openai_v1():
            from fortifyroot._vendor.opentelemetry.instrumentation.openai.v1 import OpenAIV1Instrumentor

            OpenAIV1Instrumentor().instrument(**kwargs)
        else:
            from fortifyroot._vendor.opentelemetry.instrumentation.openai.v0 import OpenAIV0Instrumentor
