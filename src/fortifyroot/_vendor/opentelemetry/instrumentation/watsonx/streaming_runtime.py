...
from fortifyroot._vendor.opentelemetry.instrumentation.watsonx.streaming_safety import (
...
def build_and_set_stream_response_delegate(
    ...
    from fortifyroot._vendor.opentelemetry.instrumentation.watsonx import (
