...
from fortifyroot._vendor.opentelemetry.instrumentation.openai.v1.responses_runtime import (
    cache_legacy_parsed_response as _cache_legacy_parsed_response,
    handle_response_error,
    handle_response_success,
    prepare_response_request,
)
from fortifyroot._vendor.opentelemetry.instrumentation.openai.v1.responses_stream_runtime import (
