...
from fortifyroot._vendor.traceloop.sdk.config import (
    is_content_tracing_enabled,
    is_tracing_enabled,
    is_metrics_enabled,
    is_logging_enabled,
)
from fortifyroot._vendor.traceloop.sdk.fetcher import Fetcher
...
class Traceloop:
    ...
    def get_default_span_processor(
        ...
        """
        from fortifyroot._vendor.traceloop.sdk.tracing.tracing import get_default_span_processor
        if headers is None:
            if api_key is None:
