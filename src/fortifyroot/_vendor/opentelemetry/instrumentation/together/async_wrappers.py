...
from fortifyroot._vendor.opentelemetry.instrumentation.together.utils import dont_throw
...
async def _awrap(
    ...
    from fortifyroot._vendor.opentelemetry.instrumentation.together import _handle_input, _handle_response
