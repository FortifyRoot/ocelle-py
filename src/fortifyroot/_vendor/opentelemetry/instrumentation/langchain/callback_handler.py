...
from fortifyroot._vendor.opentelemetry.instrumentation.langchain.event_emitter import emit_event
from fortifyroot._vendor.opentelemetry.instrumentation.langchain.event_models import (
    ChoiceEvent,
    MessageEvent,
    ToolCall,
)
from fortifyroot._vendor.opentelemetry.instrumentation.langchain.span_utils import (
    SpanHolder,
    _set_span_attribute,
...
from fortifyroot._vendor.opentelemetry.instrumentation.langchain.vendor_detection import (
